    ...
    <>
      <section id="hero" className="sections-container">
        <div className="section-content md:grid-rows-3 lg:gap-y-10">
          ...
          <h1 className="color-text text-center text-lg font-semibold md:col-span-full md:row-span-1 md:row-start-2 md:mx-auto md:text-3xl lg:text-4xl xl:text-5xl">
            &lt;Crafting intuitive
            <span className="gradient-on-text"> Front-End </span>
            experiences./&gt;
          </h1>
