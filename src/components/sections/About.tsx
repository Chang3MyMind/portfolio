...
function About() {
  return (
    <RevealSection id="about" title="Sobre">
      <div className="grid grid-cols-1 grid-rows-2 p-5 pt-0 md:col-span-full md:gap-0 md:grid-cols-2 md:grid-rows-1 xl:gap-5 row">
        ...
        <div className="my-auto">
          <h3 className="color-text text-justify text-sm font-medium md:text-base lg:text-lg xl:text-xl">
            Olá! Eu sou o Matheus Mattos, um Desenvolvedor Front-End apaixonado
            por criar interfaces responsivas e acessíveis. Sou especializado em
            HTML5, CSS3 e JavaScript moderno (ES6+). Atualmente, meu foco é
            construir projetos para meu portfólio que demonstrem minhas
            habilidades com código limpo e escalável.
          </h3>
        </div>
      </div>
    </RevealSection>
